...
# Output
Gere estritamente um array JSON bruto (sem formatação Markdown, sem ```json). Retorne APENAS o array com esta estrutura e salve o arquivo em back_log.json ordenado por severidade:
